...
public class Shop implements ShopFinder {
...
class ShopTest{
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Введите кол-во PC: ");
        int count = sc.nextInt();
        Computer[] computers = new Computer[count];
        for(int i = 0; i < count; i++){
            System.out.println("Введите параметры PC: ");
            String name = sc.next();
            int cost = sc.nextInt();
        ...
        Computer c1 = new Computer("model_1", 240);
        Computer c2 = new Computer("model_2", 54000);
        shop1.add(c1);
        System.out.println(shop1);
        shop1.add(c2);
        System.out.println(shop1);
